...
export default {
  ...
  'demo.bannerWhy':
    'Una colección inventada de libros reales donde funciona todo lo que harías con la tuya.',
  ...
  'demo.importWarningWhy':
    'Se leerá y se combinará igual que en tu propia biblioteca, y se deshará al recargar la muestra. Tu biblioteca no se toca en ningún caso. Para conservar lo que importes, empieza antes la tuya.',
  ...
  'nav.short.catalog': 'Catálogo',
  'nav.short.add': 'Añadir',
  'nav.short.desk': 'Consultas',
  'nav.short.stacks': 'Depósito',
  'nav.short.about': 'Acerca de',
  'nav.add': 'Añadir libros',
  'nav.add.hint': 'foto, lista, códigos, Kindle',
  'nav.home': 'Inicio',
  ...
  'list.shape.goodreads': 'una exportación de Goodreads',
  'list.thenLookUp': 'Buscarlos después en Open Library.',
  ...
  'fillIsbn.asking': 'Preguntando a Open Library…',
  'fillIsbn.progress': '{done} de {total}',
  'fillIsbn.back': 'Han vuelto {found}. {missing} no {missing:está|están} en Open Library.',
  'fillIsbn.check': 'Revísalos antes de guardarlos. Un número que el servicio no tiene vuelve como otro libro, no como nada.',
  'fillIsbn.pages': '{n} páginas',
  'fillIsbn.joins': 'completa {title}',
  'fillIsbn.joinsNothing': 'no encaja con nada de aquí, así que entraría como libro nuevo',
  'fillIsbn.keep': 'Guardar {n}',
  'fillIsbn.discard': 'Descartar todo',
  'fillIsbn.written': 'Guardados {n}. El catálogo tiene ahora {books} libros.',

  'list.stepOne': 'Paso uno · El archivo',
  ...
  'list.shape.kindle': 'una exportación de Kindle',
  'list.shape.calibre': 'una exportación de Calibre',
  'list.shape.other': 'otra cosa',
  'list.readAs': 'Leído como {what}. Cambia abajo lo que no sea correcto.',
  'list.readAsOther': 'Cambia abajo lo que no sea correcto.',
  'list.formatForAll': 'Se aplica a todos los libros del archivo.',
  'list.formatFromFile': 'La columna {column} decide donde lo dice; esto cubre el resto.',
  'list.withIsbn': '{n} de {total} traen ISBN.',
  'list.noIsbn': 'Ninguno trae ISBN.',
  'list.columns': 'Columnas',
  'list.columnsRead': '{n} de {of} leídas',
  'list.columnsNote': 'Cambia las que se hayan leído mal. Ignorar deja fuera una columna.',
  'list.column.ignore': 'ignorar',
  'list.columnIs': 'Qué contiene la columna {column}',
  'list.columnFilled': 'rellenó {n}',

  'list.stepThree': 'Paso tres · Los libros ({n})',
  ...
  'kindle.intro': 'Como Amazon no tiene una opci\u00f3n r\u00e1pida de exportar, tienes dos opciones:',


  'kindle.ask.head': '1. Recomendado: p\u00eddele tus datos a Amazon',
  'kindle.ask.intro': 'M\u00e1s lento, y solo requiere paciencia.',
  ...
  'kindle.ask.note': 'Este archivo trae m\u00e1s informaci\u00f3n que la segunda opci\u00f3n. LibrAPP todav\u00eda no reconoce sus columnas, as\u00ed que as\u00edgnalas en el paso dos de Subir una lista.',

  'kindle.run.head': '2. Leer la lista t\u00fa mismo',
  'kindle.run.intro': 'Cuesti\u00f3n de minutos. Vas a pegar c\u00f3digo en tu navegador, mejor en un port\u00e1til. Esto da los t\u00edtulos, los autores y los n\u00fameros de serie de Amazon. Nada m\u00e1s.',
  ...
  'kindle.then.head': 'Ahora trae tu archivo aqu\u00ed',
  ...
  'key.compact': 'Si tienes una clave de API…',
  'key.compact.active': 'Clave de API en uso: {service}',
  'key.compact.off': 'Clave de API desactivada: {service}',
  'key.benefitsLabel': 'Qué aporta una clave',
  'key.benefits':
    'Con una clave, la foto se lee y la mesa responde aquí mismo, con el coste a la vista antes de enviar nada. Sin clave, las dos cosas siguen funcionando: copia el prompt en cualquier chat de IA y trae aquí la respuesta.',
  'key.hide': 'Ocultar',
  'scheme.title': 'Colores',
  'scheme.note':
    'Cambia los botones, las marcas, los lomos y el gráfico de géneros. El papel y el texto no cambian. Un color propio se aclara u oscurece allí donde costaría leerlo.',
  'scheme.walnut': 'Nogal',
  'scheme.slate': 'Pizarra',
  'scheme.moss': 'Musgo',
  'scheme.plum': 'Ciruela',
  'scheme.own': 'El tuyo',
  'scheme.chosen': 'elegido',
