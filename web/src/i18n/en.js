...
export default {
  ...
  'demo.bannerWhy':
    'A made-up collection of actual books where everything you could do with your own collection works.',
  ...
  'demo.importWarningWhy':
    'It will be read and merged exactly as it would be in your own library, and it will be undone when you reload the demo. Your own library is not touched either way. To keep what you import, start your own first.',
  ...
  'nav.short.add': 'Add',
  'nav.short.desk': 'Desk',
  'nav.short.stacks': 'Stacks',
  'nav.short.about': 'About',
  'nav.add': 'Add books',
  'nav.add.hint': 'photograph, list, barcode, Kindle',
  'nav.home': 'Start',
  'nav.catalog': 'Catalog',
  ...
  'setUp.title': 'Set up so far',
  'setUp.storage': 'Kept in',
  'setUp.storage.action': 'Choose',
  'setUp.books': 'Books',
  'setUp.books.n': '{n}',
  'setUp.books.none': 'none yet',
  'setUp.books.action': 'Add some',
  'setUp.key': 'AI key',
  'setUp.key.stored': 'stored',
  'setUp.key.none': 'none, and optional',
  'setUp.key.action': 'Add one',
  'setup.chosen.title': 'Your catalog will be kept here',
  'setup.chosen.body': 'Nothing has been written yet.',
  'setup.chosen.next': 'Use this folder',
  'setup.chosen.change': 'Choose a different one',
  ...
  'storage.kind.demo': 'the demo, held in memory and gone when you reload',
  ...
  'list.shape.goodreads': 'a Goodreads export',
  'list.thenLookUp': 'Look them up on Open Library afterwards.',
  ...
  'fillIsbn.asking': 'Asking Open Library…',
  'fillIsbn.progress': '{done} of {total}',
  'fillIsbn.back': '{found} came back. {missing} {missing:is|are} not in Open Library.',
  'fillIsbn.check': 'Check these before keeping them. A number the service does not hold comes back as some other book rather than as nothing.',
  'fillIsbn.pages': '{n} pages',
  'fillIsbn.joins': 'fills in {title}',
  'fillIsbn.joinsNothing': 'joins nothing here, so it would arrive as a new book',
  'fillIsbn.keep': 'Keep {n}',
  'fillIsbn.discard': 'Discard the lot',
  'fillIsbn.written': 'Kept {n}. The catalog now holds {books} books.',

  'list.stepOne': 'Step one · The file',
  ...
  'list.shape.kindle': 'a Kindle export',
  'list.shape.calibre': 'a Calibre export',
  'list.shape.other': 'something else',
  'list.readAs': 'Read as {what}. Change anything below that is wrong.',
  'list.readAsOther': 'Change anything below that is wrong.',
  'list.formatForAll': 'This applies to every book in the file.',
  'list.formatFromFile': 'The {column} column decides where it says; this covers the rest.',
  'list.withIsbn': '{n} of {total} carry an ISBN.',
  'list.noIsbn': 'None of these carry an ISBN.',
  'list.columns': 'Columns',
  'list.columnsRead': '{n} of {of} read',
  'list.columnsNote': 'Change any that were read wrongly. Ignore leaves a column out.',
  'list.column.ignore': 'ignore',
  'list.columnIs': 'What the {column} column holds',
  'list.columnFilled': 'filled {n}',

  'list.stepThree': 'Step three · The books ({n})',
  'list.stepThreeWaiting': 'Step three · The books',
  'list.stepFour': 'Step four · Import',

  'landing.option.kindle': 'Books on a Kindle',
  'landing.option.kindle.hint': 'Amazon has no export button. Two ways to get the list out.',
  'list.fromKindle': 'Your books are on a Kindle?',
  ...
  'kindle.warn.2': 'This is how accounts get stolen. Never paste code into a browser console because a website, an email, a video or a stranger told you to. Not even this one.',
  'kindle.warn.3': 'Read the code below first. It is short so that you can. It reads the titles on the page and saves a file. It sends nothing anywhere, and it does not touch your account, your orders or your payment details.',
  'kindle.warn.4': 'If you would rather not, use the other route above. It gets you more.',

  'kindle.run.1': 'Open read.amazon.com/kindle-library and sign in.',
  'kindle.run.2': 'Scroll to the bottom of the list, so every book has loaded.',
  'kindle.run.3': 'Open the browser console: F12 on Windows and Linux, Option-Command-I on a Mac, then the Console tab.',
  'kindle.run.4': 'Copy the code below, paste it in the console and press Enter.',
  'kindle.run.5': 'A file called kindle-books.csv is saved to your downloads.',
  ...
  'key.compact': 'If you have an API key…',
  'key.compact.active': 'API key in use: {service}',
  'key.compact.off': 'API key switched off: {service}',
  'key.benefitsLabel': 'What a key adds',
  'key.benefits':
    'With a key, the photograph is read and the desk answers right here, with the cost shown before anything is sent. Without one, both still work: copy the prompt into any AI chat and bring the reply back.',
  'key.hide': 'Hide',
  'scheme.title': 'Colours',
  'scheme.note':
    'Changes the buttons, the marks, the spines and the genre chart. Paper and text stay as they are. A colour of your own is made lighter or darker wherever it would be hard to read.',
  'scheme.walnut': 'Walnut',
  'scheme.slate': 'Slate',
  'scheme.moss': 'Moss',
  'scheme.plum': 'Plum',
  'scheme.own': 'Your own',
  'scheme.chosen': 'chosen',
